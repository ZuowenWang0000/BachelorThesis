...
export JOB_NAME='reco_mix_ce_fo'
export config_name='configs/tradesconfig_cifar10_fo_mix_ce.json'
export local_json_folder_name='local_cifar10_recovarit_fo'
...
for VAR_WORSTOFK in 10
do
    export WORSTOFK=$VAR_WORSTOFK
    for VAR_LAMBDA_CORE in 0 1 2.5 3.5
    do
