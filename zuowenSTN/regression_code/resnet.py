...
class Model(object):
  ...
  def _build_model(self, config, filters, num_ids, differentiable=False,
    ...
    with tf.variable_scope('prediction'):
      self.predictions = self._fully_connected(x, config.n_regression_labels)
    ...
    with tf.variable_scope('costs'):
      ...
      # self.y_abs_error = tf.abs(self.predictions - self.y_input)
      # self.mean_abs_error = tf.map_fn(lambda )
      # los = tf.losses.absolute_difference(self.y_input, self.predictions)
