...
export JOB_NAME='stnfc_wo10'
export config_name='configs/wenconfig_cifar10_spatial_stnfc_wo10.json'
export local_json_folder_name='local_cifar10_stnfc_wo10'
...
do
    ...
    for VAR_LAMBDA_CORE in 0 1.0 3.5 5 8
    do
