...
export JOB_NAME='stnL_wo10'
export config_name='configs/wenconfig_cifar10_spatial_stnL_wo10.json'
export local_json_folder_name='local_cifar10_stnL_wo10'
...
do
    ...
    for VAR_LAMBDA_CORE in 0 0.5 1.0 2.0 5.0 8.0 10.0 12.0 15.0
    do
