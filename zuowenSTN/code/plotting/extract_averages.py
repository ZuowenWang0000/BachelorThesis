...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str,
                        help='dataset name',
                        default='SVHN', required=False)
    parser.add_argument('--attack', type=str,
                        help='attack name',
                        default='spatial', required=False)
    parser.add_argument('--metrics', type=str,  nargs='+',
                        help='Metrics to extract',
                        default=['test_grid_accuracy', 'test_adv_accuracy', 
                        'test_nat_accuracy'], required=False)      
    parser.add_argument('--k', type=int, nargs='+',
                        help='k for worst-of-k',
                        default=[1, 5, 10, 20], required=False)  
    ...
    parser.add_argument('--save_filename', type=str,
                        help='path to plots folder',
                        default='averages_core_robust.json', required=False)   
    ...
    save_plot_subdir = os.path.join(args.save_folder, dataset, attack, 'jsons')
    os.makedirs(save_plot_subdir, exist_ok=True)

    # save_filename = os.path.join(save_plot_subdir, 
    #     '{}_{}_av_{}_{}_k{}_lam{}_{}'.format(dataset, args.attack,
    #         args.metric, args.method, args.k, args.core_lambda, 
    #         args.save_filename))
    save_filename = os.path.join(save_plot_subdir, 
