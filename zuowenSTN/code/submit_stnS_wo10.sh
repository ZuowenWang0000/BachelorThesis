...
export JOB_NAME='stnS_wo10'
export config_name='configs/wenconfig_cifar10_spatial_stnS_wo10.json'
export local_json_folder_name='local_cifar10_stnS_wo10'
