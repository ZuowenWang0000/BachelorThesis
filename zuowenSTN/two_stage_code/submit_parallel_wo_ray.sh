...
export JOB_NAME='two-stage'
export config_name='configs/cifar10_spatial_stn_wen.json'
export local_json_folder_name='local_cifar10_stn'
export repo_dir='/cluster/home/wangzu/two-stage'
