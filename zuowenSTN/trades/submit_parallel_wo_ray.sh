...
export JOB_NAME='trades_wo10'
export config_name='configs/tradesconfig_cifar10_spatial_gr2.json'
export local_json_folder_name='local_cifar10_trades_wo10'
...
do
    ...
    for VAR_LAMBDA_CORE in 0 0.1 0.5 1 2 6 8 10 15
    do
